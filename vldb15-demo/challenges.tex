...
We leverage our prior work to design tools that tune parameters, provide recommendations, and estimate the significance of cleaning.
...
A user can specify a set of ground truth records, and our system will optimize over data cleaning plans that best reproduces the ground truth.
...
This problem can solved by a minimum-cost spanning tree over a similarity graph (edges represent non-zero similarity) over records.
